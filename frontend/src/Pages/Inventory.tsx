...
// Define the Service and Product interfaces
interface Product {
  id: string;
  name: string;
  imageUrl: string;
...
const InventoryPage = () => {
      ...
      products: [
        {
          id: "1",
          name: "Vacuum Cleaner",
          imageUrl: "https://images.unsplash.com/photo-1598756851264-c29d0b4d9d2f",
        ...
        },
        {
          id: "2",
          name: "Mop Set",
          imageUrl: "https://images.unsplash.com/photo-1576502208932-8e3e92b23a3b",
        ...
        },
        {
          id: "3",
          name: "Dusting Cloths",
          imageUrl: "https://images.unsplash.com/photo-1557692250-e6278a91c7d8",
        ...
        },
        {
          ...
          imageUrl: "https://images.unsplash.com/photo-1578932684962-2f2a3a91b6c8",
      ...
      products: [
        {
          id: "5",
          name: "Pipe Wrench",
          imageUrl: "https://images.unsplash.com/photo-1604013743516-3efedeea3651",
        ...
        },
        {
          id: "6",
          name: "Plumber’s Tape",
          imageUrl: "https://images.unsplash.com/photo-1558492971-88d8a46b7ac9",
        ...
        },
        {
          ...
          imageUrl: "https://images.unsplash.com/photo-1588204511079-4b1008fa31b6",
        ...
        },
        {
          id: "8",
          name: "Pipe Cutter",
          imageUrl: "https://images.unsplash.com/photo-1583976502122-d59b8d1be7b3",
      ...
      products: [
        {
          id: "9",
          name: "Paint Roller",
          imageUrl: "https://images.unsplash.com/photo-1591623641304-d4d58fe3409e",
        ...
        },
        {
          id: "10",
          name: "Brush Set",
          imageUrl: "https://images.unsplash.com/photo-1583349422989-6d5be69a2267",
        ...
        },
        {
          id: "11",
          name: "Painter's Tape",
          imageUrl: "https://images.unsplash.com/photo-1561563249-3d38323224f0",
        ...
        },
        {
          id: "12",
          name: "Drop Cloths",
          imageUrl: "https://images.unsplash.com/photo-1600528258813-cbe6f282d312",
      ...
      products: [
        {
          id: "13",
          name: "Wire Strippers",
          imageUrl: "https://images.unsplash.com/photo-1591577282153-018c15d87d56",
        ...
        },
        {
          id: "14",
          name: "Voltage Tester",
          imageUrl: "https://images.unsplash.com/photo-1618454877125-52a2c582a5ae",
        ...
        },
        {
          ...
          imageUrl: "https://images.unsplash.com/photo-1567485360-d97e5d826e8f",
        ...
        },
        {
          ...
          imageUrl: "https://images.unsplash.com/photo-1581944241554-551a4f05b99a",
      ...
      products: [
        {
          id: "17",
          name: "Garden Shovel",
          imageUrl: "https://images.unsplash.com/photo-1579074849225-f6e9fbd9fdf1",
        ...
        },
        {
          id: "18",
          name: "Watering Can",
          imageUrl: "https://images.unsplash.com/photo-1618935910721-e86d20814980",
        ...
        },
        {
          id: "19",
          name: "Pruning Shears",
          imageUrl: "https://images.unsplash.com/photo-1608224658481-cfd0b3a8b2db",
        ...
        },
        {
          ...
          imageUrl: "https://images.unsplash.com/photo-1604083134152-6e03be06738d",
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold text-center mb-6">Service Connect Inventory</h1>
